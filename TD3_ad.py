...
class TD3_ad(object):
    ...
    def hardupdate(self):
        ...
        for param, target_param in zip(self.critic_target.parameters(), self.list_target_critic[self.currentQNet].parameters()):
