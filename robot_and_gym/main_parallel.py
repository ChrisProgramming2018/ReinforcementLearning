...
if __name__ == "__main__":
    ...
    parser.add_argument('--env-name', default="Ant-v3", type=str, help='Name of a environment (set it to any Continous environment you want')
    ...
    parser.add_argument('--num_q_target', default=15, type=int)    # amount of qtarget nets
